...
import { POST } from "@/app/api/v1/store/apps/[appId]/update/route";
import { startAppLifecycleAction } from "@/lib/server/modules/store/service";

describe("POST /api/v1/store/apps/:appId/update", () => {
  it("starts an update operation", async () => {
    ...
    expect(json.operationId).toBe("op-update");
