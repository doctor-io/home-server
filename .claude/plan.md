...
<button
  ...
  onClick={handleSave}
  disabled={isSaving}
  className="rounded-[var(--radius)] bg-primary px-6 py-2 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2"
>
