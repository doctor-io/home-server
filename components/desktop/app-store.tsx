...
const storeApps: StoreApp[] = [
  // Installed apps
  {
    ...
    size: "348 MB",
    description:
      "Stream your media library to any device. The leading media server for your home.",
    developer: "Plex Inc.",
    status: "installed",
  },
  {
    ...
    downloads: "1.8M",
    version: "28.0.2",
    latestVersion: "29.0.0",
    size: "1.02 GB",
    description:
      "Self-hosted file sync and share solution. Your own cloud storage platform.",
  ...
  },
  {
    ...
    size: "289 MB",
    description:
      "Network-wide ad blocking via your own DNS server. Protect all your devices.",
  ...
  },
  {
    ...
    size: "1.84 GB",
    description:
      "Open source home automation platform. Control all your smart devices.",
    developer: "Nabu Casa",
    status: "update_available",
  },
  {
    ...
    size: "297 MB",
    description:
      "Universal container management platform. Manage Docker with ease.",
  ...
  },
  {
    ...
    size: "578 MB",
    description:
      "Free software media system. Stream to any device from your own server.",
  ...
  // Not installed apps
  {
    ...
    size: "12 MB",
    description:
      "Modern, fast, and lean VPN tunnel. Simplest and fastest VPN available.",
  ...
  },
  {
    ...
    size: "102 MB",
    description:
      "Lightweight self-hosted Git service. Fast, simple, and painless.",
  ...
  },
  {
    ...
    size: "67 MB",
    description:
      "A highly customizable homepage with Docker and service integrations.",
  ...
  },
  {
    ...
    downloads: "420K",
    version: "",
    latestVersion: "231128",
    size: "1.1 GB",
    description:
      "AI-powered photo management. Browse, organize, and share your photo collection.",
  ...
  },
  {
    ...
    size: "425 MB",
    description:
      "Document management system that transforms physical docs into searchable archives.",
  ...
  },
  {
    ...
    size: "325 MB",
    description:
      "Dedicated Minecraft Java server. Host your own survival or creative world.",
    developer: "Mojang",
    status: "not_installed",
  },
  {
    ...
    size: "490 MB",
    description:
      "Personal media server with live TV, DVR, and parental controls.",
    developer: "Emby LLC",
    status: "not_installed",
  },
  {
    ...
    downloads: "910K",
    version: "",
    latestVersion: "1.23.11",
    size: "187 MB",
    description:
      "Self-hosted monitoring tool. Monitor HTTP, TCP, DNS, and more.",
    developer: "Louis Lam",
    status: "not_installed",
  },
  {
    ...
    size: "23 MB",
    description:
      "Continuous file synchronization. Sync files between devices securely.",
  ...
  },
  {
    ...
    size: "35 MB",
    description:
      "Zero config VPN that just works. Mesh networking made simple.",
...
const categories = [
  "All",
  ...Array.from(new Set(storeApps.map((a) => a.category))).sort(),
];
...
function StatusBadge({ status }: { status: AppStatus }) {
  switch (status) {
    ...
    case "update_available":
      return (
        <span className="flex items-center gap-1 text-xs font-medium text-status-amber">
    ...
    case "uninstalling":
      return (
        <span className="flex items-center gap-1 text-xs font-medium text-status-red animate-pulse">
    ...
    setTimeout(
      () => {
        ...
        setSelectedApp((prev) => {
          ...
          if (action === "uninstall")
            return { ...prev, status: "not_installed", version: "" };
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex items-start gap-5 mb-6">
            <div
              className={`size-20 rounded-3xl flex items-center justify-center ${app.bgColor} ${app.color} shadow-lg shadow-black/20 shrink-0`}
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {app.status === "update_available" && (
                  <>
                    ...
                    >
                      <ArrowUpCircle className="size-3.5" /> Update to{" "}
                      {app.latestVersion}
                    </button>
                    <button
                      onClick={() => doAction(app.id, "uninstall")}
          ...
          <div className="grid grid-cols-4 gap-3 mb-6">
            {[
              ...
              <div
                key={item.label}
                className="flex flex-col gap-1 p-3 rounded-xl bg-glass border border-glass-border"
              >
          ...
          {(app.status === "update_available" ||
            ...
            <div className="mb-6">
              <h3 className="text-sm font-semibold text-foreground mb-2">
                {"What's New in " + app.latestVersion}
              </h3>
      ...
      <div className="flex items-center gap-3 px-5 py-3 border-b border-glass-border shrink-0">
        ...
        {updateCount > 0 && (
          <button
            onClick={() => {
              apps
                .filter((a) => a.status === "update_available")
                .forEach((a) => doAction(a.id, "update"));
            }}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-primary text-primary-foreground rounded-lg hover:brightness-110 transition-all cursor-pointer"
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
              {filtered.map((app) => (
                ...
                >
                  {/* Icon */}
                  <div
                    className={`size-12 rounded-2xl flex items-center justify-center ${app.bgColor} ${app.color} shadow-md shadow-black/15 shrink-0`}
                  >
                  ...
                  >
                    ...
                    {app.status === "not_installed" && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          doAction(app.id, "install");
                        }}
                        className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium bg-primary/15 text-primary rounded-md hover:bg-primary/25 transition-colors cursor-pointer"
                      >
