...
export function AppConfiguratorPanel({
  ...
  return (
    <div className="flex h-full flex-col bg-card/90">
      ...
      <footer className="flex items-center justify-between border-t border-glass-border px-3 py-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-full bg-primary px-3 py-1 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60"
        >
