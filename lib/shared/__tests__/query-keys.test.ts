...
describe("query keys", () => {
  it("exports stable cache keys", () => {
    ...
    expect(queryKeys.systemPreferences).toEqual(["system", "preferences"]);
    expect(queryKeys.systemUpdates).toEqual(["system", "updates"]);
    expect(queryKeys.systemSecurity).toEqual(["system", "security"]);
